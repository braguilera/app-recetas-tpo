...
            const data = await getRecipesPaginatedWithAuth(params, 'Error al cargar datos de receta');

            setDatesRecipeRepite(data)
...
            (isRecipeNameAvailable && fetchRecipeRepite)
